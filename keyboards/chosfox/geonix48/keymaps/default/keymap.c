...
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    LGUI_T(KC_Z), LCTL_T(KC_X), KC_C,         LALT_T(KC_V), KC_B,            KC_MS_L, KC_MS_R, KC_N,           RALT_T(KC_M), KC_COMMA,     KC_DOT,       RGUI_T(KC_SLASH),
    KC_BTN3,      KC_MPLY,      KC_BTN4,      KC_BTN5,      LT(2, KC_SPACE), KC_WH_D, KC_WH_U, LT(5, KC_BSPC), KC_WH_L,      KC_WH_R,      KC_MNXT,      KC_MPLY
),
...
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    TG(_L),  TO(_QUD),        _______,        _______,          _______, _______, _______, _______,  KC_INSERT,     KC_PSCR,       KC_SCRL,       KC_PAUSE
),

[_RAISE] = LAYOUT_ortho_4x12(
    TO(_NUM), KC_HOME,          KC_UP,            KC_END,           KC_PGUP, _______, _______, KC_CAPS, _______,              KC_LANGUAGE_2,   IME_TOGGLE,      KC_APPLICATION,
    _______,  LALT_T(KC_LEFT),  LCTL_T(KC_DOWN),  LSFT_T(KC_RIGHT), KC_PGDN, _______, _______, KC_BSPC, RSFT_T(KC_SEMICOLON), RCTL_T(KC_LBRC), RALT_T(KC_RBRC), KC_P,
    _______,  _______,          QK_AREP,          QK_REP,           _______, _______, _______, _______, KC_ENTER,             S(KC_LBRC),      S(KC_RBRC),      RGUI_T(KC_SLASH),
...
[_ADJUST] = LAYOUT_ortho_4x12(
    ...
    _______, LCAG(KC_S), LCAG(KC_D), LCAG(KC_F), LCAG(KC_G), _______, _______, _______, RSFT_T(KC_TRNS), RCTL_T(KC_TRNS), RALT_T(KC_TRNS), _______,
...
[_L] = LAYOUT_ortho_4x12(
    ...
    TO(_QWERTY), KC_TRNS, KC_LALT, KC_LCTL, KC_SPACE, KC_SPACE, _______, _______, _______,  _______, _______,      _______
),
...
[_R] = LAYOUT_ortho_4x12(
    ...
    KC_GRAVE,     KC_6,         KC_7,         KC_8,         KC_EQUAL, _______, _______, _______, _______,         _______,       _______,          _______,
    _______,      _______,      _______,      _______,      _______,  _______, _______, _______, _______,         _______,       _______,          _______
),
...
[_QUD] = LAYOUT_ortho_4x12(
    KC_Q,        KC_W,    KC_E,    KC_R,    KC_T,              _______,           _______, KC_Y,            KC_U,    KC_I,     KC_O,    KC_P,
    KC_A,        KC_S,    KC_D,    KC_F,    KC_G,              _______,           _______, KC_H,            KC_J,    KC_K,     KC_L,    KC_MINUS,
    KC_Z,        KC_X,    KC_C,    KC_V,    KC_B,              _______,           _______, KC_N,            KC_M,    KC_COMMA, KC_DOT,  KC_EQL,
    TO(_QWERTY), _______, _______, _______, LT(_QUD2, KC_SPC), LT(_QUD3, KC_ENT), KC_LCTL, ALT_T(KC_BSPC),  KC_LSFT, _______, _______, _______
),

[_QUD2] = LAYOUT_ortho_4x12(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,      _______, _______, KC_ESC,  KC_P7,   KC_P8,   KC_P9,   KC_PMNS,
    KC_F6,   KC_F7,   KC_F8,   KC_F9,   LCAG(KC_G), _______, _______, KC_TAB,  KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
    KC_F10,  KC_F11,  KC_F12,  _______, KC_BSLS,    _______, _______, KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_GRV,
    _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______, _______
),

[_QUD3] = LAYOUT_ortho_4x12(
